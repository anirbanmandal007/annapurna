...
export class SidebarComponent implements OnInit {
  ...
  getRoute(routeName: string): any {
    ...
    case "Sftp Upload": {
      ...
      case "Customer":{
        route = { path: "Customer", title: "Customer", type: "link" }
        break;
      }
      case "Customer Mapping":{
        route = { path: "customer-mapping", title: "Customer Mapping", type: "link" }
        break;
      }
      ...
      case "Region":{
        route = { path: "Region", title: "Region", type: "link" }
        break;
      }
      case "Region Mapping":{
        route = { path: "region-mapping", title: "Region Mapping", type: "link" }
        break;
      }
      ...
      case "Quick Search":{
        route = { path: "content-search", title: "Quick Search", type: "link" }
        break;
      }
      case "File Storage":{
