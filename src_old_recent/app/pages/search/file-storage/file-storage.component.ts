...
// }
  ...
  //  // const apiUrl = this._global.baseAPIUrl + 'SearchFileStatus/getSearchDataFilestorage?UserID=' + localStorage.getItem('UserID') + '&user_Token=' + localStorage.getItem('User_Token') + '&TemplateID=' + this.FileStorageForm.get('TemplateID').value 
  //   // const apiUrl="https://demo2993066.mockable.io/getAllData";
  ...
  //         // let DocTypes = [{ DocType: row.DocType, documentCount: row.DocCount, Files: files, isExpanded: false }]
  //         // let Accounts = [{ AccNo: row.AccNo, documentCount: 1, DocTypes: DocTypes, isExpanded: indx == 0 ? true : false }]
  //         let branches = [{BranchName: row.BranchName}]
  //         deptName.push({ DepartmentName: row.DepartmentName, branches: branches, documentCount: 1, isExpanded: indx == 0 ? true : false })
  //       } 
  //       else {
  //         let dept = deptName.find(b => b.DepartmentName == row.DepartmentName)
  ...
  //           // let DocTypes = [{ DocType: row.DocType, documentCount: row.DocCount, Files: files, isExpanded: false }]
  //           // let Account = { AccNo: row.AccNo, documentCount: 1, DocTypes: DocTypes, isExpanded: false }
  //           dept.branches.push({BranchName: row.BranchName})
  //           dept.documentCount += 1
  //         } else {
  //          // let account = branch.Accounts.find(b => b.AccNo == row.AccNo)
  //          // let inDocTypesArray = account.DocTypes.some(b => b.DocType == row.DocType)
  ...
  nodeSelect(e) {
    ...
    this.GetFileInfo(e.originalEvent.currentTarget.querySelector('span:last-child span').textContent.split('(')[0], isNodeSelect);
  ...
  GetFileInfo(Fileno: any, isNodeSelect?) {

    this.selectedRows = [];
    const apiUrl = this._global.baseAPIUrl + 'Status/GetFileStorageData?UserID=' + localStorage.getItem('UserID') + '&FileNo=' + Fileno + '&user_Token=' + localStorage.getItem('User_Token')+ '&TemplateID=' + this.FileStorageForm.get('TemplateID').value
